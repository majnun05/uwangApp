      ...
      <SafeAreaView style={[styles.modalBodyPin, styles.center_]}>
        <View style={[styles.pl20, styles.pr20]}>
          ...
          {props.tanpaPin === 'yes' ? (
            ...
            <View style={[styles.CheckoutSectionStyleCheck, styles.mt5]}>
              <TextInput
        ...
        {props.tanpaPin === 'no' ? (
          <View style={[styles.row, styles.mt10, styles.ml15, styles.mr15]}>
            ...
            <View style={[styles.mt3, styles.pl5, styles.pr10, styles.col90]}>
              <Text style={[styles.black, styles.fs11, styles.fontWSR]}>
                PIN yang dimasukkan harus benar
              </Text>
            </View>
          </View>
        ) : (
          <View style={[styles.row, styles.mt10, styles.ml15, styles.mr15]}>
            ...
            <View style={[styles.mt3, styles.pl5, styles.pr10, styles.col90]}>
              <Text style={[styles.black, styles.fs11, styles.fontWSR]}>
                Anda menggunakan transaksi tanpa PIN
              </Text>
            </View>
          </View>
        )}
          ...
          <View style={[styles.col50, styles.pr5]}>
            <Ripple
              ...
              style={[
                ...
                props.redButton ? {borderColor: '#FF931C'} : null,
              ]}>
              <Text
                style={[
                  props.redButton ? {color: '#FF931C'} : styles.green,
                  styles.fontWSB,
                  styles.fs13,
                ]}>
                {props.titleClose}
              ...
              style={
                props.value === ''
                  ...
                  : [
                      ...
                      props.redButton
                        ? {backgroundColor: '#FF931C', borderColor: '#FF931C'}
                        : null,
                    ]
              }>
