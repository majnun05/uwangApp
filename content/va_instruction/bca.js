      ...
      <View
        ...
        <View
          ...
          <Text style={[styles.fs12, styles.black, styles.fontWSR]}>
            ...
            , misal.{' '}
            <Text style={[styles.fontWSB, styles.fs12]}>123456789012XXXX</Text>
          </Text>
        </View>
      </View>
      <View
    ...
    <ScrollView
      ...
      <View
        ...
        <View
          ...
          <Text style={[styles.fs12, styles.black, styles.fontWSR]}>
            Pilih <Text style={[styles.fontWSB, styles.fs12]}>m-Transfer</Text>
          </Text>
        </View>
      </View>
      <View
      ...
      <View
        ...
        <View
          ...
          <Text style={[styles.fs12, styles.black, styles.fontWSR]}>
            Klik <Text style={[styles.fontWSB, styles.fs12]}>Send</Text>
          </Text>
        </View>
      </View>
      <View
      ...
      <View
        ...
        <View
          ...
          <Text style={[styles.fs12, styles.black, styles.fontWSR]}>
            Input <Text style={[styles.fontWSB, styles.fs12]}>PIN</Text> Mobile
            Banking
          </Text>
        </View>
      </View>
    ...
    <ScrollView
      ...
      <View
        ...
        <View
          ...
          <Text style={[styles.fs12, styles.black, styles.fontWSR]}>
            Pilih{' '}
            <Text style={[styles.fontWSB, styles.fs12]}>Transaksi Dana</Text>
          </Text>
        </View>
      </View>
      <View
      ...
      <View
        ...
        <View
          ...
          <Text style={[styles.fs12, styles.black, styles.fontWSR]}>
            Klik <Text style={[styles.fontWSB, styles.fs12]}>Lanjutkan</Text>
          </Text>
        </View>
      </View>
      <View
