...
import {IcArrR, IcCopas} from '../../assets';
moment.locale('id');

const TopupDone = (props) => {
  ...
  const [intruksi, setInstruksi] = useState(false);
  let isMounted = true;
  ...
  return (
    <SafeAreaView style={[styles.flex1, styles.bgWhite]}>
      ...
      <ScrollView
        ...
        <View style={[styles.pl15, styles.pr15, styles.mb50, styles.mt10]}>
          <Text style={[styles.fs15, styles.black, styles.fontWSB]}>
            Pilihan Bank
          </Text>
          <Text
        ...
        <View
          ...
          <View style={styles.col70}>
            ...
            <TouchableOpacity
              ...
              <View
                style={[styles.row, styles.ml20, styles.mt7, styles.leftText]}>
