...
const KartuKredit = (props) => {
  ...
  const [produk, setProduk] = useState('Kartu Kredit');
      ...
      .then((res) => {
        if (isMounted) {
          ...
          if (res.statusCode === 200) {
            let val = res.values;
            let op = val.values.productTokpedKartuKredit;
            setOperatorId(op);

            let kets = val.values.ketKartuKredit;
      ...
      <ScrollView
        ...
        <View style={[styles.contentTopForm]}>
          <View style={[styles.ml10, styles.mr10]}>
            ...
            <Ripple
              onPress={() => {
                navigation.push('KartuKreditProduk', {
