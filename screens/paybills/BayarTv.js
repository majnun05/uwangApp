...
const BayarTv = (props) => {
  ...
  const [produk, setProduk] = useState('Bayar TV');
      ...
      .then((res) => {
        if (isMounted) {
          ...
          if (res.statusCode === 200) {
            ...
            let kets = val.values.ketBayarTv;
      ...
      <ScrollView
        ...
        <View style={[styles.contentTopForm]}>
          <View style={[styles.ml10, styles.mr10]}>
            ...
            <TouchableNativeFeedback
              onPress={() => {
                navigation.push('BayarTvProduk', {
                  operatorId: operatorId,
                });
              }}>
              <View style={[styles.row, styles.arePage]}>
