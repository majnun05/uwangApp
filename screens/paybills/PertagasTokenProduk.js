...
import ContentProduk from '../../content/fitur/ContentProduk';
import IconSearch from '../../assets/svg/search.svg';
import IconEmpty from '../../assets/svg/empty.svg';

const PertagasTokenProduk = (props) => {
  ...
  const renderItem = React.useCallback(({item, index}) => {
    return (
      <ContentProduk
        key={index}
        onPress={() => {
          navigation.navigate('PertagasToken', {
            detail: item,
          });
        }}
        image={item.imgUrl}
...
export default PertagasTokenProduk;
