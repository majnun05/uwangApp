...
const Finance = (props) => {
  ...
  const [produk, setProduk] = useState('Cicilan Finance');
      ...
      .then((res) => {
        if (isMounted) {
          ...
          if (res.statusCode === 200) {
            let val = res.values;
            let op = val.values.productPpob_finance;
            setOperatorId(op);

            let kets = val.values.ketCicilanFinance;
        ...
        <View style={[styles.widgedPulsa]}>
          <View style={[styles.ml10, styles.mr10]}>
            <View style={styles.PulsaLabelPhone}>
              <Text style={styles.PulsaTextPhone}>Penyedia Pinjaman</Text>
            </View>
            <Ripple
              onPress={() => {
                navigation.push('FinanceProduk', {
              ...
              <View style={[styles.col90]}>
                <Text
                  ...
                  {productName ? productName : 'Pilih Pinjaman'}
                </Text>
              </View>
