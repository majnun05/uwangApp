...
const VoucherDataDetail = (props) => {
  ...
  const [isVoucherKosong, setIsVoucherKosong] = useState(
    params.isVoucherKosong,
  );
  const [produk, setProduk] = useState('Voucher Data');
...
export default VoucherDataDetail;
