...
import {apiPricePaketData} from '../../helpers/endPoint';
...
const PriceListPaketData = () => {
  ...
  const isLogged = async (hal) => {
    await useApiPost(apiPricePaketData(), {
      page: 1,
    })
      .then((res) => {
        if (isMounted) {
  ...
  return (
    <SafeAreaView style={[styles.flex1, styles.bgWhite]}>
      <Header
        ...
        right={false}
      />
      <TabPriceList menu="Paket Data" navigation={navigation} />
...
export default PriceListPaketData;
