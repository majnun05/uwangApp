...
import {apiPricePulsa} from '../../helpers/endPoint';
...
const PriceListPulsa = () => {
  ...
  const isLogged = async (hal) => {
    await useApiPost(apiPricePulsa(), {
      page: 1,
    })
      .then((res) => {
        if (isMounted) {
  ...
  return (
    <SafeAreaView style={[styles.flex1, styles.bgWhite]}>
      ...
      <TabPriceList menu="Pulsa" navigation={navigation} />
