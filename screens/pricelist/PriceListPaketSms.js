...
import {apiPricePaketSms} from '../../helpers/endPoint';
...
const PriceListPaketSms = () => {
  ...
  const isLogged = async (hal) => {
    await useApiPost(apiPricePaketSms(), {
      page: 1,
    })
      .then((res) => {
        if (isMounted) {
  ...
  return (
    <SafeAreaView style={[styles.flex1, styles.bgWhite]}>
      ...
      <TabPriceList menu="Telepon & SMS" navigation={navigation} />
...
export default PriceListPaketSms;
