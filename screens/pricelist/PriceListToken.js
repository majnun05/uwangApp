...
import {apiPriceToken} from '../../helpers/endPoint';
...
const PriceListToken = () => {
  ...
  const isLogged = async (hal) => {
    await useApiPost(apiPriceToken(), {
      page: 1,
    })
      .then((res) => {
        if (isMounted) {
  ...
  return (
    <SafeAreaView style={[styles.flex1, styles.bgWhite]}>
      ...
      <TabPriceList menu="Token" navigation={navigation} />
